...
public class CrossHairPaint {
    ...
    public CrossHairPaint(SpectralChart dataChartPane) {
        ...
        //鼠标移动事件
        this.parent.dataChartPane.addMouseMotionListener(new MouseMotionAdapter() {
            @Override
        ...
        //鼠标点击事件
        this.parent.dataChartPane.addMouseListener(new MouseAdapter() {
                ...
                if (IsCrossHairPaintEnable()) {
                    ...
                    if (e.getButton() == MouseEvent.BUTTON1) {
                        ...
                        if (selectedhair != null) {
                            ...
                            parent.chartrangePaint.EnableZoom(false);
                        }
                    }
                }
            }
                ...
                if (IsCrossHairPaintEnable()) {
                    ...
                    if (e.getButton() == MouseEvent.BUTTON1) {
                        if (selectedhair != null) {
                            ...
                            //恢复chart图表自动缩放的功能
                            parent.chartrangePaint.EnableZoom(true);
                        }
                        selectedhair = null;
                    }
                }
