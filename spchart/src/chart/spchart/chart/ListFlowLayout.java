...
public class ListFlowLayout extends FlowLayout {
    ...
    public ListFlowLayout(int align, int hgap, int vgap, int f_vgap, boolean hfill, boolean vfill) {
        setAlignment(align);
        this.hgap = hgap;
        this.vgap = vgap;
        this.hfill = hfill;
        this.vfill = vfill;
        this.first_vgap = f_vgap;
    }
...
//        this.vfill = true;
    ...
    public void layoutContainer(Container target) {
        ...
        placethem(target, x, insets.top + vgap + first_vgap, colw, maxheight - y, start, numcomp);
    }
}
