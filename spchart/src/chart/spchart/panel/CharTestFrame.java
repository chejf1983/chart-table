...
public class CharTestFrame extends javax.swing.JFrame {
    ...
    private final SpectralChartPane spectralChartPane2;
    ...
    public CharTestFrame() {
        ...
        this.Area.setLayout(new CardLayout());
        this.Area.add(spectralChartPane2);
    }
...
//        id++;
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ret.add(this.spectralChartPane2.GetFreeTextPaint().CreateNewLable("test input" + i++));
