...
public class TestTable extends javax.swing.JFrame {
     ...
     */
    SPDataTablePane spDataTablePane = new SPDataTablePane();

    public TestTable() {
        initComponents();

        this.jPanel1.setLayout(new CardLayout());
        this.jPanel1.add(spDataTablePane);
        spDataTablePane.SetTitle("123", "aaa");
//        LanguageHelper.getIntance().SetLanguage(LanguageNode.Language.Chinese);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double[] wave = new double[1024];

        for (int i = 0; i < wave.length; i++) {
            wave[i] = i;
            testdata[i] = i + j++;
        }
        spDataTablePane.UpdateData(new TSPData(wave, testdata));
